...
class UserController extends Controller
{
    ...
    public function updateRoute(Request $request)
    {
        // Validasi input
        $request->validate([
            'route_id' => 'required|integer', // Ubah sesuai kebutuhan validasi Anda
        ]);
        ...
        // Perbarui route_id pengguna
        $user->route_id = $request->route_id;
        $user->save();

        // Kembalikan respons sukses
        return response()->json(['message' => 'User route_id updated successfully'], 200);
    }
